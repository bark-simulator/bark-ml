...
class FQF(BaseModel):
    ...
    def __init__(self, num_channels, num_actions, params, N=64, num_cosines=32, dueling_net=False, noisy_net=False,
        ...
        self.dqn_net = DQNBase(num_channels=num_channels, embedding_dim=self.embedding_dim, hidden=params["ML"]["FQFModel"]["HiddenDims", "", 512])
        ...
        self.quantile_net = QuantileNetwork(
            ...
            noisy_net=noisy_net, embedding_dim=self.embedding_dim)
