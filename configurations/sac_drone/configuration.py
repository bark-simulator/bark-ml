...
from configurations.sac_drone.custom_evaluator import CustomEvaluator
from configurations.sac_drone.custom_observer import CustomObserver
...
def run_configuration(argv):
  params = ParameterServer(filename="configurations/sac_drone/config.json")
